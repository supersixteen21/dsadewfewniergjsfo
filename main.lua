...
local OldAtlasGui2 = game:GetService("CoreGui"):FindFirstChild("AtlasKeySystem")
if OldAtlasGui2 then
    OldAtlasGui:Destroy()
end
...
loadingimage.Position = UDim2.new(0.319562584, 0, 0.168689325, 0)
loadingimage.Size = UDim2.new(0.2708, 0, 0.4787, 0)
...
function Atlas1.CreateWindow(libName, logoId)
    ...
    key1.Size = UDim2.new(0.040, 0, 0.020, 0)
    key1.ZIndex = 2
    ...
    keybindInfo1.Size = UDim2.new(0.026, 0, 0.020, 0)
    ...
    function TabHandling:Tab(tabText, tabId)
        ...
        function sectionHandling:Section(sectionText)
            ...
            function ItemHandling:Button(btnText, callback)
                ...
                ButtonFrame.Size = UDim2.new(0.190, 0, 0.033, 0)

                TextButton.Parent = ButtonFrame
                TextButton.BackgroundColor3 = Color3.fromRGB(18, 18, 18)
                TextButton.Size = UDim2.new(0.190, 0, 0.033, 0)
                TextButton.ZIndex = 2
                ...
                TextButton.MouseButton1Up:Connect(function()
                    TextButton:TweenSize(UDim2.new(0.190, 0, 0.033, 0), "InOut", "Quint", 0.18, true)
                ...
                TextButton.MouseButton1Down:Connect(function()
                    if not debounce1 then
                        debounce1 = true
                        TextButton:TweenSize(UDim2.new(0.187, 0, 0.028, 0), "InOut", "Quint", 0.18, true)
                        game.TweenService:Create(TextButton, TweenInfo.new(0.18, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),{
                ...
                function ItemHandling:Toggle(toggInfo, callback)
                    ...
                    ToggleFrame.Size = UDim2.new(0.190, 0, 0.033, 0)
                    ...
                    checkBtn.MouseButton1Up:Connect(function()
                        checkBtn.Parent:TweenSize(UDim2.new(0.190, 0, 0.033, 0), "InOut", "Quint", 0.18, true)
                    end)

                    checkBtn.MouseButton1Down:Connect(function()
                        checkBtn.Parent:TweenSize(UDim2.new(0.187, 0, 0.028, 0), "InOut", "Quint", 0.18, true)
                    end)
                end
                    ...
                    function ItemHandling:KeyBind(keyInfo, first, callback)
                        ...
                        KeyBindFrame.Size = UDim2.new(0.190, 0, 0.033, 0)
                        ...
                        keybindInfo.Size = UDim2.new(0.124, 0, 0.020, 0)
                        ...
                        key.MouseButton1Click:connect(function(e) 
                            keybindFrame:TweenSize(UDim2.new(0.187, 0, 0.028, 0), "InOut", "Quint", 0.18, true)
                            key.Text = ". . ."
                            local a, b = game:GetService('UserInputService').InputBegan:wait();
                            if a.KeyCode.Name ~= "Unknown" then
                                keybindFrame:TweenSize(UDim2.new(0.190, 0, 0.033, 0), "InOut", "Quint", 0.18, true)
                        ...
                        function ItemHandling:TextBox(infbix, textPlace, callback)
                            ...
                            TextBoxFrame.Size = UDim2.new(0.190, 0, 0.033, 0)
                            ...
                            textboxInfo.Size = UDim2.new(0.124, 0, 0.020, 0)
                            ...
                            function anim(property)
                                if property == "Text" then
                                    textboxFrame:TweenSize(UDim2.new(0.187, 0, 0.028, 0), "InOut", "Quint", 0.18, true)
                                    wait(0.18)
                                    textboxFrame:TweenSize(UDim2.new(0.190, 0, 0.033, 0), "InOut", "Quint", 0.18, true)
                                end
                            end
                            ...
                            function ItemHandling:Slider(slidInfo, minvalue, maxvalue, callback)
                                ...
                                SliderFrame.Size = UDim2.new(0.190, 0, 0.033, 0)
                                ...
                                sliderbtn.Size = UDim2.new(0.078, 0, 0.006, 0)
                                sliderbtn.ZIndex = 2
                                ...
                                dragSlider.Size = UDim2.new(0, 0, 0.006, 0)
                                dragSlider.ZIndex = 2
                                ...
                                dragPrecent.Size = UDim2.new(0.023, 0, 0.014, 0)
                                ...
                                triangle.Size = UDim2.new(0.023, 0, 0.036, 0)
                                triangle.ZIndex = 2
                                ...
                                sliderInfo.Size = UDim2.new(0.100, 0, 0.033, 0)
                                sliderInfo.ZIndex = 2
                                ...
                                function anim(property)
                                    if property == "Size" then
                                        sliderFrame:TweenSize(UDim2.new(0.187, 0, 0.028, 0), "InOut", "Quint", 0.18, true)
                                        wait(0.18)
                                        sliderFrame:TweenSize(UDim2.new(0.190, 0, 0.033, 0), "InOut", "Quint", 0.18, true)
                                    end
                                end
                            ...
                            function ItemHandling:Label(labelInfo)
                                ...
                                TextLabelFrame.Size = UDim2.new(0.190, 0, 0.033, 0)
                                ...
                                TextLabel.Size = UDim2.new(0.190, 0, 0.033, 0)
                                TextLabel.ZIndex = 2
                            ...
                            function ItemHandling:Credit(creditWho)
                                ...
                                function ItemHandling:DropDown(dropInfo, list, callback)
                                    ...
                                    DropDownFrame.Size = UDim2.new(0.190, 0, 0.033, 0)
                                    ...
                                    dropdownFrameMain.Size = UDim2.new(0.190, 0, 0.033, 0)
                                    ...
                                    expand_more.MouseButton1Click:Connect(function()
                                        if isDropped1 then
                                            isDropped1 = false
                                            DropDownFrame:TweenSize(UDim2.new(0.190, 0, 0.033, 0), "In", "Quint", 0.10)
                                    ...
                                    for i,v in next, list do
                                        ...
                                        optionBtn1.MouseButton1Down:Connect(function()
                                            optionBtn1:TweenSize(UDim2.new(0.174, 0, 0.028, 0), "InOut", "Quint", 0.12, true)
                                        ...
                                        optionBtn1.MouseButton1Up:Connect(function()
                                            optionBtn1:TweenSize(UDim2.new(0.176, 0, 0.031, 0), "InOut", "Quint", 0.12, true)
                                            game.TweenService:Create(optionBtn1, TweenInfo.new(0.18, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),{
                                                BackgroundColor3 = Color3.fromRGB(101, 168, 157),
                                                TextColor3 = Color3.fromRGB(0,0,0)
                                            }):Play()
